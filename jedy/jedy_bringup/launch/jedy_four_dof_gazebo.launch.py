...
def generate_launch_description():
    ...
    model_file = os.path.join(get_package_share_directory('jedy_bringup'), 'urdf', 'jedy_four_dof_gz.xacro')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('model', default_value=os.path.join(get_package_share_directory('jedy_bringup'), 'urdf', 'jedy_four_dof_gz.xacro')),
