...
configurable_parameters = [{'name': 'camera_name',                   'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'pointcloud.enable',             'default': 'true', 'description': ''}, # <--- MODIFIED
                           {'name': 'pointcloud.stream_filter',      'default': '2', 'description': 'texture stream for pointcloud'},
                           {'name': 'pointcloud.stream_index_filter','default': '0', 'description': 'texture stream index for pointcloud'},
                           {'name': 'pointcloud.ordered_pc',         'default': 'false', 'description': ''},
                           {'name': 'pointcloud.allow_no_texture_points', 'default': 'false', 'description': "''"},
                           {'name': 'align_depth.enable',            'default': 'true', 'description': 'enable align depth filter'}, # <--- MODIFIED
...
def launch_setup(context, params, param_name_suffix=''):
    ...
    lifecycle_param_file = os.path.join(
        '/opt/ros/jazzy/share/realsense2_camera/config/global_settings.yaml'
    )
