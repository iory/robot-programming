...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '640,480,5', 'description': 'depth stream profile'},
                           ...
                           {'name': 'depth_module.color_profile',   'default': '640,480,5', 'description': 'Depth module color stream profile for d405'},
...
def launch_setup(context, params, param_name_suffix=''):
    ...
    lifecycle_param_file = os.path.join(
        realsense2_camera_share, 'config', 'global_settings.yaml'
    )
